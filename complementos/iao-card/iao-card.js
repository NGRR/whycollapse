(function(){
  var CAPACITIES=[
    ...
    {title:"Agilidad",body:"Responder con rapidez, coordinación y capacidad de decisión.",x:638,y:298,labelX:678,labelY:289},
    ...
    {title:"Antifragilidad",body:"Aprender de la incertidumbre y fortalecerse. Capacidad de convertir las crisis en ventajas competitivas.",x:122,y:298,labelX:78,labelY:289}
  ];
  ...
  panel.addEventListener("click",function(e){
    if(e.target===panel){window.location.hash="";syncOpenState();card.focus();}
  });
  document.addEventListener("keydown",function(e){
    if(e.key==="Escape"&&window.location.hash==="#iaoPanel"){window.location.hash="";syncOpenState();card.focus();}
  });
